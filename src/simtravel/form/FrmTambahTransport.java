 ...
 * @author nursalim
 */
public class FrmTambahTransport extends javax.swing.JDialog {
    ...
    public FrmTambahTransport(java.awt.Frame parent, boolean modal, Map data) {
        super(parent, modal);
        con = new DBUtils().getKoneksi();
        userId = (String) data.get("userId");
        action = (String) data.get("action");
        String namaTransport = (String) data.get("namaTransport");
        ...
        if(action.equals("edit")){
            ...
            //bandaraField.setText(status);
            tarifField.setText(tarif);
            levelCB.setSelectedItem(kelas);
            levelCB1.setSelectedItem(status);
        }
    ...
    public void tambahRecord(){
        ...
        try {
            ...
            ps.setString(3, levelCB1.getSelectedItem().toString());
    ...
    public void updateRecord(){
        ...
        try {
            ...
            System.out.println("    ==>> : [Update]Transport == "+userId);
    ...
    private void initComponents() {
        ...
        judulLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/simtravel/image/transport-32.png"))); // NOI18N
        judulLabel.setText("Tambah Transport");
        ...
        jLabel2.setText("Nama Transport");
        ...
        levelCB1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pulang-Pergi", "Antar", "Jemput" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(levelCB1, 0, 223, Short.MAX_VALUE))))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTambahTransport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmTambahTransport dialog = new FrmTambahTransport(new javax.swing.JFrame(), true, null);
